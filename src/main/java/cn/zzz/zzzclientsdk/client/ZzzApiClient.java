package cn.zzz.zzzclientsdk.client;
...
import cn.zzz.zzzclientsdk.utils.SignUtils;
 ...
 * @author zzz
 */
public class ZzzApiClient {

    public static String GATEWAY_HOST = "http://47.115.217.43/:8090";

    private String accessKey;

    private String secretKey;

    public ZzzApiClient(String accessKey, String secretKey) {
